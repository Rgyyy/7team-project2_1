<div>
  ...
  <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-16">
    <div className="max-w-6xl mx-auto px-4 text-center">
      <h1 className="text-2xl font-bold mb-4">나중에 보자고 말만 하지 말고</h1>
  ...
  <article className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
    ...
    >
      ...
      <p className="text-sm text-gray-500 mt-2">밴드, 합주, 작곡 스터디 등.</p>
    </a>
    {/* <!-- 독서 --> */}
    <a
      href="#reading"
  ...
  <aside className="sm:mt-4 lg:mt-8 space-y-3">
    ...
    <details className="bg-white rounded-xl shadow-sm" open>
      ...
      <div className="faqPanel px-5 pb-5 text-gray-700">
        <p>
          네, 꼭 필요합니다. 모임 생성, 신청이 계정 기반으로 관리되며, 사용자
          보안과 원활한 운영을 위해 로그인이 필수입니다.
        </p>
      </div>
    </details>
    {/* <!-- FAQ 2: 비용 문구 --> */}
    <details className="bg-white rounded-xl shadow-sm">
      ...
      <div className="faqPanel px-5 pb-5 text-gray-700">
        <p>
          대부분의 모임은 무료로 운영되지만, 재료비나 강사료가 발생하는 경우가
          있습니다.
        </p>
      </div>
    </details>
